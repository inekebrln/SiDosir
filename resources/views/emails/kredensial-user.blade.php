...
<body>
    <div class="container">
        <div class="header">
            <h2 style="margin:0">SIPDosir</h2>
            <p style="margin:4px 0 0; font-size:13px">Sistem Informasi Dosir</p>
        </div>

        <p>Halo, <strong>{{ $user->name }}</strong>!</p>
        <p>Akun SIPDosir Anda telah dibuat oleh admin. Berikut kredensial login Anda:</p>
        ...
        <p style="margin-top:20px">Akses SIPDosir di: <a href="{{ config('app.url') }}">{{ config('app.url') }}</a></p>

        <div class="footer">
            Email ini dikirim otomatis oleh sistem SIPDosir. Jangan balas email ini.
        </div>
    </div>
</body>
</html>